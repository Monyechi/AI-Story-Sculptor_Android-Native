...
sealed class Route(val value: String) {
    ...
    data object ChapterReader : Route("main/details/{bookId}/chapter/{chapterId}") {
        fun withIds(bookId: Long, chapterId: Long): String = "main/details/$bookId/chapter/$chapterId"
    }
}
